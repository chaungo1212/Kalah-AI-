...
public class KalahGUI {
	...
	private void initialize() {
		 ...
		 * btnSaveSeeds.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent e) { try { if (seeds_per == null) {
		 * seeds_per = textFieldSeeds.getText(); } int temp =
		 * Integer.parseInt(seeds_per); if (temp <= 10 && temp > 0) {
		 * 
		 * } else { JOptionPane.showMessageDialog(null,
		 * "Please enter a Number from 1 to 10"); } } catch (Exception e1) {
		...
		btnNext.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (username.equals("") || seeds_per.equals("") || group.getSelection() == null || houses_per.equals("")) {
